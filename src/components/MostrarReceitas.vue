...
export default{
    ...
    data() {
     return {
        todasAsReceitas: [] as IReceita[]
     };   
   },
   async created() {
    this.todasAsReceitas = await obterReceitas();
   },
   computed:{
    receitasEncontradas() {
      ...
      return this.todasAsReceitas.filter((receita) => {
    ...
    <h1 class="cabecalho titulo-receitas">Receitas</h1>
        ...
        <div v-if="receitasEncontradas.length" class="receitas-wrapper">
            <p class="paragrafo-lg informacoes">
                Veja as opções de receitas que encontramos com os ingredientes que vocẽ tem por ai!
            </p>
        ...
        <div v-else class="receitas-nao-encontradas">
            ...
            <img src="../assets/imagens/sem-receitas.png"
                alt="Desenho de um ovo quebrado. A gema tem um rosto com uma express�o triste.">
        </div>
